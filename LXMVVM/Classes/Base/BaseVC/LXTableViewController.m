...
#import "LXTableViewCellStyleValue1.h"
...
- (UIEdgeInsets)contentInset {
    return UIEdgeInsetsMake(kTopHeight, 0, kTabBarHeight, 0);
}
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[LXTableViewCellStyleValue1 class] forCellReuseIdentifier:@"MRCTableViewCellStyleValue1"];
...
- (void)bindViewModel {
    ...
    [RACObserve(self.viewModel, dataSource).distinctUntilChanged subscribeNext:^(id x) {
        @strongify(self)
