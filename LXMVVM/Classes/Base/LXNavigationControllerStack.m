...
@interface LXNavigationControllerStack ()
...
@implementation LXNavigationControllerStack

+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    LXNavigationControllerStack *navigationControllerStack = [super allocWithZone:zone];
...
- (void)registerNavigationHooks {
    ...
    [[(NSObject *)self.services
     ...
     subscribeNext:^(RACTuple *tuple) {
         @strongify(self)
         UIViewController *viewController = (UIViewController *)[LXRouter.sharedInstance viewControllerForViewModel:tuple.first];
    ...
    [[(NSObject *)self.services
     ...
     subscribeNext:^(RACTuple *tuple) {
         ...
         //rootVC
         UIViewController *viewController = (UIViewController *)[LXRouter.sharedInstance viewControllerForViewModel:tuple.first];
         LXDelegate.window.rootViewController = viewController;
     }];
}
